    ...
    showHeadquartersPage() {
        ...
        this.genericContent.innerHTML = `
            <div class="hq-container">
                <h2 style="margin-bottom: 10px; font-weight: 300; letter-spacing: 2px;">Headquarters</h2>
                <div class="hq-grid">
                    <div class="hq-box">
                        <h4>Florida | USA</h4>
                        <p>54 SE 5th Avenue, Suite 300<br>Delray Beach, FL 33483</p>
                        <a href="tel:+18774230226"><span class="hq-label">TOLL FREE</span>+1-877-423-0226</a>
                        <a href="tel:+15617050350"><span class="hq-label">PHONE</span>+1-561-705-0350</a>
                        <p><span class="hq-label">FAX</span>+1-561-391-0546</p>
                        <a href="mailto:operations.amer@imigroup.com">operations.amer@imigroup.com</a>
                    ...
                    <div class="hq-box">
                        ...
                        <a href="tel:+5531991828338"><span class="hq-label">PHONE</span>+55 (31) 99182-8338</a>
                        <a href="mailto:operations.latam@imigroup.com">operations.latam@imigroup.com</a>
                    </div>
                    <div class="hq-box">
                        <h4>Dubai | UAE</h4>
                        <p>IMI Middle East Trading L.L.C.<br>Offices 801 & 802, Tower A, The Offices, One Za’abeel, Za’abeel Palace St, Dubai, U.A.E</p>
                        <a href="tel:+97147760100"><span class="hq-label">PHONE</span>+971-4-776-0100</a>
                        <a href="mailto:operations.asia@imigroup.com">operations.asia@imigroup.com</a>
                        <a href="#" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                        <h4>Madrid | Spain</h4>
                        <p>IMI Europe, SLU<br>Calle Velázquez 123. 2º PL, 28006 Madrid, Spain</p>
                        <a href="tel:+34915641045"><span class="hq-label">PHONE</span>+34-915-64-1045</a>
                        <a href="mailto:operations.eur@imigroup.com">operations.eur@imigroup.com</a>
                        <a href="#" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                        ...
                        <a href="tel:+8618217739459"><span class="hq-label">PHONE</span>+86-182-1773-9459</a>
                        <a href="mailto:operations.asia@imigroup.com">operations.asia@imigroup.com</a>
                        <a href="#" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                        ...
                        <a href="tel:+6563035680"><span class="hq-label">PHONE</span>+65-6303-5680</a>
                    ...
                    <div class="hq-box">
                        ...
                        <a href="mailto:imicol@imigroup.com">imicol@imigroup.com</a>
                        <a href="#" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                    ...
                    <div class="hq-box">
                        ...
                        <a href="tel:+902122625151"><span class="hq-label">PHONE</span>+90 212 262 51 51</a>
                        <a href="mailto:operations.eur@imigroup.com">operations.eur@imigroup.com</a>
                        <a href="#" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                        ...
                        <a href="tel:+442038260003"><span class="hq-label">PHONE</span>+44 20 3826 0003</a>
                        <a href="mailto:operations.eur@imigroup.com">operations.eur@imigroup.com</a>
                        <a href="#" class="map-link">Map & Directions</a>
                    </div>
                </div>
