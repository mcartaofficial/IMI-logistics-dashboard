    ...
    renderRelocatedSections() {
        document.getElementById('services-section').innerHTML = `
            ...
            <div class="services-grid">
                ...
                <div class="service-box">
                    <h4>Sourcing</h4>
                    <p>IMI holds multi-year contracts and marketing rights with suppliers for many products including natural gypsum from Oman, Spain and Mexico; bauxite from Australia and Turkey; and cement/clinker worldwide.</p>
                    <button class="read-me-btn">Read Me</button>
                </div>
                <div class="service-box">
                    <h4>Chartering</h4>
                ...
                <div class="service-box">
                    <h4>Logistics</h4>
                    <p>IMI manages +50 global stock-and-sell centers for coal, gypsum, bauxite, slag, iron ore products and clinker, supporting door-to-door deliveries.</p>
                    <button class="read-me-btn">Read Me</button>
                </div>
                <div class="service-box">
                    <h4>Marketing</h4>
                ...
                <div class="service-box">
                    ...
                    <p>IMI’s technical and trade support capabilities are unmatched in the industry, providing custom financing solutions to suppliers and customers.</p>
                    <button class="read-me-btn">Read Me</button>
                </div>
            </div>
        `;
        ...
        document.getElementById('environmental-section').innerHTML = `
            <div class="env-container">
                ...
                <ul class="commitment-list">
                    ...
                    <li class="commitment-item">
                        <div class="red-bullet"></div>
                        <div class="commitment-text">By selecting suppliers dedicated to these principles, we aim to support more sustainable resource management.</div>
                    </li>
                    <li class="commitment-item">
                        <div class="red-bullet"></div>
        ...
        document.getElementById('hq-section').innerHTML = `
            ...
            <div class="hq-container">
                <div class="hq-grid">
                    ...
                    <div class="hq-box">
                        <h4>Dubai | UAE</h4>
                        <p>IMI Middle East Trading L.L.C.<br>The Offices, One Za’abeel, Za’abeel Palace St, Dubai, U.A.E</p>
