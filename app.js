...
class MILogisticsApp {
    ...
    constructor() {
        ...
        this.analysisPages = {
            // Link to the Optimization Model spreadsheet view
            "OPTIMIZATION_MODEL": "https://fau-my.sharepoint.com/personal/nmadrazo2024_fau_edu/_layouts/15/Doc.aspx?sourcedoc={1efa517b-4d2d-448a-bbc0-03df00a251b4}&action=embedview&AllowTyping=True&ActiveCell='Original%20Model'!O1&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True&edaebf=rslc0",
            ...
            // Link to the Rotterdam SARIMA forecasting sheet
            "ROTTERDAM_SARIMA": "https://fau-my.sharepoint.com/personal/nmadrazo2024_fau_edu/_layouts/15/Doc.aspx?sourcedoc={d402df77-54ee-45a3-bf61-08b31aa14687}&action=embedview&AllowTyping=True&ActiveCell='Rotterdam%20ARIMA%20Table'!A1&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True&edaebf=rslc0",
            ...
            // Link to the Brent Oil SARIMA forecasting sheet
            "BRENT_SARIMA": "https://fau-my.sharepoint.com/personal/nmadrazo2024_fau_edu/_layouts/15/Doc.aspx?sourcedoc={387040cf-f417-4999-974f-e082d18765e8}&action=embedview&AllowTyping=True&ActiveCell='Brent%20ARIMA%20Table'!A1&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True&edaebf=rslc0",
    ...
    buildSidebar() {
        ...
        // Add a button for the Optimization Model spreadsheet
        this.createNavItem('OPTIMIZATION_MODEL', 'OPTIMIZATION_MODEL', () => this.switchExcelPage('OPTIMIZATION_MODEL', 'Optimization Model'));
        ...
        // Add a button for Rotterdam SARIMA
        this.createNavItem('ROTTERDAM SARIMA', 'ROTTERDAM_SARIMA', () => this.switchExcelPage('ROTTERDAM_SARIMA', 'Rotterdam SARIMA'));
        ...
        // Add a button for Brent SARIMA
        this.createNavItem('BRENT SARIMA', 'BRENT_SARIMA', () => this.switchExcelPage('BRENT_SARIMA', 'Brent SARIMA'));
