class MILogisticsApp {
            ...
            <div class="hq-container">
                <div class="hq-grid">
                    <div class="hq-box">
                        ...
                        <a href="#" class="hq-link-special">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                    ...
                    <div class="hq-box">
                        <h4>Dubai | UAE</h4>
                        <p>IMI Middle East Trading L.L.C.<br>Offices 801 & 802, Tower A, One Za’abeel, Dubai, U.A.E</p>
                    ...
                    <div class="hq-box">
                        ...
                        <p>Shanghai Representative Office, Suite 306B, Jinzhong Road 968#, Shanghai, China</p>
                    ...
                    <div class="hq-box">
                        ...
                        <p>Avenida Paseo de la Reforma 404, Piso 13, Interior 102. Colonia Juárez, Mexico City</p>
                        <p><a href="mailto:operations.latam@imigroup.com">operations.latam@imigroup.com</a></p>
                        <a href="#" class="hq-link-special">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                    ...
                    <div class="hq-box">
                        ...
                        <p>IMI South Africa (Pty) Ltd, Workshop 17 The Bank, Johannesburg, 2196</p>
                        <p><a href="mailto:operations.asia@imigroup.com">operations.asia@imigroup.com</a></p>
                    </div>
                    <div class="hq-box">
                        <h4>Istanbul | Turkey</h4>
                        <p>Kampanaki Mansion, Yeniköy 34464 Sarıyer, Istanbul, Turkey</p>
                    ...
                    <div class="hq-box">
                        <h4>London | UK</h4>
                        <p>International Materials UK Ltd, Office 102, London SW3 6RD, UK</p>
        ...
        this.genericContent.innerHTML = `
            <div class="env-container">
                ...
                <ul class="commitment-list">
                    ...
                    <li class="commitment-item"><div class="red-bullet"></div><div class="commitment-text">By selecting suppliers dedicated to these principles, we aim to support efforts that contribute to more sustainable resource management.</div></li>
    ...
    showServicesPage() {
        ...
        this.hideAllViews();
        this.genericView.classList.add('active');
        this.genericContent.innerHTML = `<div class="services-grid"><div class="service-box"><h4>Global Bulk Raw Materials Trading</h4><p>IMI is a leading independent bulk raw materials trading firm.</p><button class="read-me-btn">Read Me</button></div></div>`;
    }
    ...
    showHomePage() {
        ...
        if (!document.getElementById('home-content').innerHTML) {
            ...
            document.getElementById('map-container').innerHTML = `<div class="hard-clip-wrapper" style="height: 800px;"><iframe src="${this.widgetConfig.shipXplorer}" style="width: 100%; height: 100%; border: none;"></iframe></div>`;
        }
    }
