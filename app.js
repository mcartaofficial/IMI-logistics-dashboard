            ...
            <div class="hq-container">
                <div class="hq-grid">
                    <div class="hq-box">
                        ...
                        <p><span class="hq-label">FAX</span><a href="tel:+15613910546">+1-561-391-0546</a></p>
                        <p><a href="mailto:operations.amer@imigroup.com">operations.amer@imigroup.com</a></p>
                        <a href="https://maps.google.com" target="_blank" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                    ...
                    <div class="hq-box">
                        ...
                        <p>Suite 306B, Skybridge Plaza, Jinzhong Road 968#, Changning, Shanghai, China</p>
                    ...
                    <div class="hq-box">
                        ...
                        <p><span class="hq-label">FAX</span><a href="tel:+6563035681">+65-6303-5681</a></p>
                        <p><a href="mailto:operations.asia@imigroup.com">operations.asia@imigroup.com</a></p>
                        <a href="https://maps.google.com" target="_blank" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
                        <h4>Mexico City | Mexico</h4>
                        <p>Avenida Paseo de la Reforma Número 404, Piso 13, Interior 102. Mexico City, 06600</p>
                        <p><a href="mailto:operations.latam@imigroup.com">operations.latam@imigroup.com</a></p>
                        <a href="https://maps.google.com" target="_blank" class="map-link">Map & Directions</a>
                    </div>
                    <div class="hq-box">
