class MILogisticsApp {
    constructor() {
        ...
        this.analysisPages = {
            ...
            "ROTTERDAM_EXP_SMOOTH": "https://fau-my.sharepoint.com/personal/nmadrazo2024_fau_edu/_layouts/15/Doc.aspx?sourcedoc={20d1f016-82b3-467b-94ed-1bd03c0b7c1f}&action=embedview&AllowTyping=True&ActiveCell='Rotterdam%20Exp%20Smooth%20Table'!A1&wdDownloadButton=True&wdInConfigurator=True&edaebf=rslc0",
    ...
    renderRelocatedSections() {
        document.getElementById('services-section').innerHTML = `
            ...
            <div class="services-grid">
                ...
                <div class="service-box">
                    <h4>Sourcing</h4>
                    <p>IMI holds multi-year contracts and marketing rights with suppliers for many products including natural gypsum from Oman, Spain and Mexico.</p>
                    <button class="read-me-btn">Read Me</button>
                </div>
                <div class="service-box">
                    <h4>Chartering</h4>
                    <p>IMI has a first class reputation as a reliable expert in ocean vessel chartering, import/export operations, and logistics planning.</p>
                    <button class="read-me-btn">Read Me</button>
                </div>
                <div class="service-box">
                    <h4>Logistics</h4>
                ...
                <div class="service-box">
                    ...
                    <p>IMI’s technical and trade support capabilities are unmatched in the industry and ensures accurate, on-time delivery.</p>
                    <button class="read-me-btn">Read Me</button>
                </div>
            </div>
        `;
    ...
    buildSidebar() {
        ...
        this.createNavItem('ABOUT PAGE', 'ABOUT', () => this.renderAboutPage());
    ...
    renderAboutPage() {
        ...
        this.genericContent.innerHTML = `
            <div class="about-hero-stats">
                <div class="stat-item">
                    <div class="stat-content"><h2>45M MT</h2><p>Total Volume</p></div>
                </div>
                <div class="stat-item">
                    <div class="stat-content"><h2>+1000</h2><p>Shipments</p></div>
                </div>
                <div class="stat-item">
                    <div class="stat-content"><h2>+$4 BILLION</h2><p>Turnover</p></div>
                </div>
                <div class="stat-item">
                    <div class="stat-content"><h2>+170</h2><p>Global Employees</p></div>
                </div>
            </div>
            
            <div class="about-main-layout">
                <h1 class="about-headline">
                    Providing value-added solutions to the global <b>cement</b>, <b>steel</b>, <b>wallboard</b> and <b>energy</b> industries for over 38 years.
                </h1>
