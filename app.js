class MILogisticsApp {
    constructor() {
        ...
        this.analysisPages = {
            ...
            "FORECASTING_MODELS": "https://fau-my.sharepoint.com/personal/nmadrazo2024_fau_edu/_layouts/15/Doc.aspx?sourcedoc={20d1f016-82b3-467b-94ed-1bd03c0b7c1f}&action=embedview&AllowTyping=True&ActiveCell='Rotterdam%20Exp%20Smooth'!A1&wdDownloadButton=True&wdInConfigurator=True",
    ...
    buildSidebar() {
        ...
        // 3. UPDATED NAME HERE
        this.createNavItem('FORECASTING TIME SERIES MODELS', 'FORECASTING_MODELS', () => this.switchExcelPage('FORECASTING_MODELS', 'Forecasting Time Series Models'));
    ...
    createNavItem(text, id, callback) {
        ...
        btn.textContent = text; // Clean text only
        btn.onclick = () => {
            callback();
            this.sidebar.classList.add('collapsed');
        };
